...
angular.module('citizen-engagement', ['ionic','ionic.service.core', 'leaflet-directive', 'citizen-engagement.auth', 'citizen-engagement.constants', 'citizen-engagement.controllers', 'citizen-engagement.services', 'ui.router', 'ui.select', 'ngSanitize'])
...
/*.controller('TestController', function($http) { // test controller just to see header is written automatically.. must include in a template with "ng-controller"
  $http({
    url: apiUrl + '/issues'
  })
})
